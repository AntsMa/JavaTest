...
/**
        ...
        public  void oper(int x) {
                try {
                        Thread.sleep(10L);
                  /*      System.out.println(System.nanoTime()+"__"+ Thread.currentThread().getName()+ "____"+ "运行开始，增加“" + x +"”，当前用户账户余额为：" + this.cash + ",cash:"+cash);
                        this.cash += x;
                        System.out.println(System.nanoTime()+"__"+ Thread.currentThread().getName()+ "____"+ "运行结束，增加“" + x +"”，当前用户账户余额为：" + this.cash + ",cash:"+cash);*/
                        synchronized(this){
