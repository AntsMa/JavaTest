...
public class RorWLockTest {
        public static void main(String[] args) {
                ...
                User1 u6 = new User1("张三他爹", MyCount1, 0, lock,true);
                User1 u7 = new User1("张三他爹", MyCount1, 0, lock,true);
                User1 u8 = new User1("张三他爹", MyCount1, 0, lock,true);
